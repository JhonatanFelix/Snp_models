...
def bo_search(dataset_tuple, bo_config_filepath):
    ...
    bayesianOptCheckpointPath = os.path.join(make_sure_dir(bo_config['checkpoint_path']), make_filename(bo_setting, postfix='.json'))
    ...
    optimizer.save_state(path=bayesianOptCheckpointPath)
